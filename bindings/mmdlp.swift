...
public protocol MmDlpEngineProtocol: AnyObject, Sendable {
    
    func downloadAndMux(videoUrl: String, audioUrl: String, outputPath: String, callback: DownloadProgressCallback) throws 
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeMmDlpEngine: FfiConverter {
    typealias FfiType = UInt64
    typealias SwiftType = MmDlpEngine

    public static func lift(_ handle: UInt64) throws -> MmDlpEngine {
        return MmDlpEngine(unsafeFromHandle: handle)
    }

    public static func lower(_ value: MmDlpEngine) -> UInt64 {
        return value.uniffiCloneHandle()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> MmDlpEngine {
        let handle: UInt64 = try readInt(&buf)
        return try lift(handle)
    }

    public static func write(_ value: MmDlpEngine, into buf: inout [UInt8]) {
        writeInt(&buf, lower(value))
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMmDlpEngine_lift(_ handle: UInt64) throws -> MmDlpEngine {
    return try FfiConverterTypeMmDlpEngine.lift(handle)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMmDlpEngine_lower(_ value: MmDlpEngine) -> UInt64 {
    return FfiConverterTypeMmDlpEngine.lower(value)
}




public struct FfmpegProgress: Equatable, Hashable {
    public var frame: UInt64?
    public var fps: Float?
    public var q: Float?
    public var sizeKb: UInt64?
    ...
    public init(frame: UInt64?, fps: Float?, q: Float?, sizeKb: UInt64?, time: String?, bitrate: String?, speed: Float?) {
        self.frame = frame
        self.fps = fps
        self.q = q
        self.sizeKb = sizeKb
...
#if compiler(>=6)
extension FfmpegProgress: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeFfmpegProgress: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FfmpegProgress {
        return
            try FfmpegProgress(
                frame: FfiConverterOptionUInt64.read(from: &buf), 
                fps: FfiConverterOptionFloat.read(from: &buf), 
                q: FfiConverterOptionFloat.read(from: &buf), 
                sizeKb: FfiConverterOptionUInt64.read(from: &buf), 
                time: FfiConverterOptionString.read(from: &buf), 
                bitrate: FfiConverterOptionString.read(from: &buf), 
                speed: FfiConverterOptionFloat.read(from: &buf)
        )
    }

    public static func write(_ value: FfmpegProgress, into buf: inout [UInt8]) {
        FfiConverterOptionUInt64.write(value.frame, into: &buf)
        FfiConverterOptionFloat.write(value.fps, into: &buf)
        FfiConverterOptionFloat.write(value.q, into: &buf)
        FfiConverterOptionUInt64.write(value.sizeKb, into: &buf)
        FfiConverterOptionString.write(value.time, into: &buf)
        FfiConverterOptionString.write(value.bitrate, into: &buf)
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeFfmpegProgress_lift(_ buf: RustBuffer) throws -> FfmpegProgress {
    return try FfiConverterTypeFfmpegProgress.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeFfmpegProgress_lower(_ value: FfmpegProgress) -> RustBuffer {
    return FfiConverterTypeFfmpegProgress.lower(value)
}


public struct MediaFormat: Equatable, Hashable {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(formatId: String, url: String, ext: String, width: UInt32?, height: UInt32?, vcodec: String?, acodec: String?, filesize: UInt64?) {
...
#if compiler(>=6)
extension MediaFormat: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeMediaFormat: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> MediaFormat {
        return
            try MediaFormat(
                ...
                vcodec: FfiConverterOptionString.read(from: &buf), 
                acodec: FfiConverterOptionString.read(from: &buf), 
                filesize: FfiConverterOptionUInt64.read(from: &buf)
        )
    }

    public static func write(_ value: MediaFormat, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionString.write(value.vcodec, into: &buf)
        FfiConverterOptionString.write(value.acodec, into: &buf)
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMediaFormat_lift(_ buf: RustBuffer) throws -> MediaFormat {
    return try FfiConverterTypeMediaFormat.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMediaFormat_lower(_ value: MediaFormat) -> RustBuffer {
    return FfiConverterTypeMediaFormat.lower(value)
}
...
public struct MediaInfo: Equatable, Hashable {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(id: String, title: String, description: String?, uploader: String?, duration: UInt32?, formats: [MediaFormat]) {
        self.id = id
        self.title = title
...
public struct FfiConverterTypeMediaInfo: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> MediaInfo {
        return
            try MediaInfo(
                ...
                formats: FfiConverterSequenceTypeMediaFormat.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: MediaInfo, into buf: inout [UInt8]) {
        ...
        FfiConverterSequenceTypeMediaFormat.write(value.formats, into: &buf)
    }
}
...
public enum EngineError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
    ...
    case OsApiError(message: String)
...
public struct FfiConverterTypeEngineError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> EngineError {
        ...
        case 1: return .FileSystemError(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 2: return .DecryptionError(
            message: try FfiConverterString.read(from: &buf)
        )
...
public protocol DownloadProgressCallback: AnyObject, Sendable {
    ...
    func onProgress(progress: FfmpegProgress) 
...
fileprivate struct UniffiCallbackInterfaceDownloadProgressCallback {
        ...
        onProgress: { (
            ...
            let makeCall = {
                ...
                return uniffiObj.onProgress(
                     progress: try FfiConverterTypeFfmpegProgress_lift(progress)
                )
            }
        ...
        onError: { (
            ...
            let makeCall = {
                ...
                return uniffiObj.onError(
                     error: try FfiConverterTypeEngineError_lift(error)
                )
            }
    ...
    nonisolated(unsafe) static let vtablePtr: UnsafePointer<UniffiVTableCallbackInterfaceDownloadProgressCallback> = {
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeMediaFormat: FfiConverterRustBuffer {
    typealias SwiftType = [MediaFormat]

    public static func write(_ value: [MediaFormat], into buf: inout [UInt8]) {
        let len = Int32(value.count)
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeMediaFormat.write(item, into: &buf)
        }
    }
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [MediaFormat] {
        ...
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeMediaFormat.read(from: &buf))
        }
        return seq
    }
}
